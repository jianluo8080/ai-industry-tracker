...
// ==================== 第一章：中游数据代理 ====================
{
  ...
  metrics: [
    ...
    },
    {
      ...
      unit: 'B (十亿 tokens/天)',
      frequency: '月',
      source: 'DeepSeek API 统计 / 阿里云通义 / 月之暗面 Kimi / 智谱 AI / 百度文心 / 腾讯元宝 公开数据综合',
      chartType: 'dual',
      color: '#ef4444',
...
// ==================== 第三章：需求端 ====================
{
  ...
  metrics: [
    ...
    },
    {
      ...
      unit: '指数 (2024.01=100)',
      frequency: '月',
      source: 'OpenAI API 企业使用统计 / Microsoft 365 Copilot 遥测数据 / Google Workspace AI 使用报告 / 综合估算',
      chartType: 'dual',
      color: '#6366f1',
...
// ==================== 第四章：个人用户渗透率 ====================
{
  ...
  metrics: [
    ...
    },
    {
      ...
      unit: '%',
      frequency: '月',
      source: 'CNNIC 第 55 次中国互联网络发展状况统计报告 / QuestMobile / 各公司披露 MAU 去重估算',
      chartType: 'line',
      color: '#f59e0b',
    ...
    },
    {
      ...
      unit: '%',
      frequency: '季度',
      source: '豆包/Kimi/通义/文心 财报披露 / 艾瑞咨询 AI 付费报告 / QuestMobile 付费用户监测',
      chartType: 'dual',
      color: '#10b981',
...
// ==================== 第五章：企业渗透率 ====================
{
  ...
  metrics: [
    ...
    },
    {
      ...
      definition: '四大云厂商 (MSFT, GOOGL, META, AMZN) 合计资本开支 / 合计自由现金流 x 100%。比率超过 100% 意味着 Capex 已超过 FCF，处于"借新还旧"状态',
      formula: 'sum(MSFT+GOOGL+META+AMZN Capex) / sum(MSFT+GOOGL+META+AMZN FCF) x 100%',
      significance: '比率从 2023.Q1 的 122% 升至 2026.Q2 的 1150%，Capex 已远超 FCF。类比 2008 年次贷危机前的杠杆率飙升，AI 基础设施投资正以不可持续的速度吞噬现金流。数据来源：各公司 10-Q/10-K 现金流量表',
  ...
  metrics: [
    {
      ...
      unit: '%',
      frequency: '季度',
      source: 'OpenRouter API 调用分类统计 / Anthropic 年度使用报告 / Cursor 开发者遥测 / GitHub Copilot 使用数据',
      chartType: 'combined',
      color: '#8b5cf6',
  ...
  metrics: [
    {
      ...
      significance: 'AI 基础设施债务 2 年增长 10 倍 ($5B -> $50B+)，CAGR 约 150%，增速远超 2008 年次贷债务同期 (5 年 5 倍，CAGR 约 38%)。如果 AI ROI 无法兑现，这些债务将成为系统性风险源。数据来源：S&P Global / Moody\'s 债券市场报告',
      signal: '债务规模超过 $100B 且违约率上升 = 严重风险。当前 $50B (2026.Q2)，关注年度违约率变化',
      data: [
    ...
    },
    {
      ...
      definition: 'AI 基础设施债务规模 / 全球名义 GDP (IMF 2026 年预计约 $110T) x 100%。用于衡量 AI 债务的系统性风险敞口',
      formula: 'AI infra debt (十亿美元) / Global GDP (十亿美元) x 100%',
      significance: '当前比率 0.045%，远低于 2008 年次贷债务/GDP (约 8%)。但增速极快 (2024-2026 CAGR ~250%)，如果按当前增速，3 年内将达到 2008 水平。数据源：S&P Global / Moody\'s / IMF GDP 估算',
      data: [
